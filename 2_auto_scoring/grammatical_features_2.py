...
essays = pd.read_csv('data/intermediate/essays_and_scores.csv',  encoding = "ISO-8859-1")
...
#essays.to_csv('data/intermediate/processed_essays.csv')
#uncomment the above line to save the csv file